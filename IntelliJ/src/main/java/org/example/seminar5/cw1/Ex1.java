...
public static void main(String[] args) {
    ...
    String str = "ewwee dqqweejbdqew jhbewqeqweqweqeewqwfe";
...
// }
    ...
    for (var entry:mapCh.entrySet()) {          //  entrySet множество символов и их значений
        System.out.println(entry.getKey()+" встретился - "+entry.getValue()+" раз");   // getKey ключ, getValue значения
    }
}
}
